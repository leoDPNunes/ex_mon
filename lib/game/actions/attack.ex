defmodule ExMon.Game.Actions.Attack do
  ...
  defp calculate_power(move), do: Enum.random(@move_avg_power)
  defp calculate_power(move), do: Enum.random(@move_rnd_power)
  ...
  defp update_opponent_life(life, opponent, damage) do
    ...
    |> Game.fetch_player()
    |> Map.put(:life, life)
    |> update_opponent(opponent, damage)
  end

  defp update_opponent(player, opponent, damage) do
    Game.info()
